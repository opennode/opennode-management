...
__all__ = [OmsRoot, Machines, Computes, Compute, Templates, Template, Network, NetworkInterface, Storage, NewsItem,  'creatable_models']


creatable_models = dict((cls.__name__.lower(), cls)
                        for cls in [Compute, Template, Network, NetworkInterface, Storage, VirtualizationContainer, Hangar, NewsItem])
